...
int main()
{
    ...
    curs_set(FALSE); // cursor占쏙옙 占쏙옙占쏙옙占쏙옙 占십곤옙 占쌌니댐옙. 
    start_color();
    noecho(); // 占쌉뤄옙占쏙옙 占쌘듸옙占쏙옙占쏙옙 화占썽에 占쏙옙占쏙옙占쏙옙占� 占십듸옙占쏙옙 占쌌니댐옙.
    ...
    init_color(14,1000,700,0 ); // 占쏙옙占쏙옙 (占쏙옙占쏙옙占�)
    init_color(15, 1000, 400,0); // 占쌈몌옙占쏙옙 (占쏙옙占쏙옙占쏙옙)
    init_pair(4, 14, 14); //占쏙옙 占쏙옙占쏙옙 占쏙옙
    init_pair(5,  15, 15); // 占쏙옙 占쌈몌옙 占쏙옙
    //s
    attron(COLOR_PAIR(5));
    mvprintw(x+0, y+2, "00");
    mvprintw(x+0, y+4, "00");
